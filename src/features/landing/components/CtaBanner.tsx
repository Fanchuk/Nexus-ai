...
export function CtaBanner() {
  return (
    <section className="px-6 py-24">
      <Reveal className="relative mx-auto max-w-5xl overflow-hidden rounded-[2rem] border border-white/12 bg-gradient-to-br from-[#2a35d6]/40 via-[#6b4ee0]/30 to-[#9747d2]/35 px-6 py-16 text-center">
