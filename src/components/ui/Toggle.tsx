export default function Toggle({ defaultChecked = false }: { defaultChecked?: boolean }) {
  return (
    <label className="relative inline-flex cursor-pointer items-center">
      ...
      <span className="h-6 w-11 rounded-full bg-raised transition-colors duration-300 peer-checked:bg-gradient-to-r peer-checked:from-iris peer-checked:to-magenta" />
